...
exponential_decay_corr_func = function( corr_function_params = list( dist_matrix = NULL, phi = NULL, l = NULL ) ) {
  ...
  # error managing
  stopifnot( 'corr_function_params : NOT STRUCTURED CORRECTLY!!!\n 
             List names should be : {dist_matrix, phi, l}' = 
               names( corr_function_params ) == c( 'dist_matrix', 'phi', 'l' ) )
  stopifnot( 'corr_function_params : DOES NOT CONTAIN VALID VALUES!!!\n 
  ...
  stopifnot( 'corr_function_params : DIST.MATRIX NOT SQUARE!!!\n 
