...
#' @export
#'
spatialwwinference <- function(ww_data,
                               count_data,
                               model_spec = spatialwwinference::get_model_spec(
                                 forecast_date =
                                   "2023-12-06"
                               ),
                               mcmc_options = spatialwwinference::
                               get_mcmc_options(),
                               compiled_model = spatialwwinference::
                               compile_model()) {
...
get_model_spec <- function(
    ...
    calibration_time = 90,
    forecast_horizon = 28,
    generation_interval = spatialwwinference::generation_interval,
    inf_to_count_delay = spatialwwinference::inf_to_hosp,
    infection_feedback_pmf = spatialwwinference::generation_interval,
    params = get_params(
